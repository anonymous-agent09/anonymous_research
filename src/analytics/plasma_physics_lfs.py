...
PLASMA_DEVICES_SET = {
    ...
    "plasma accelerating apparatus",
    "plasma adjusting system",
    "plasma density distribution controller",
    "plasma generating space chamber",
    "plasma generation apparatus",
    "ACCELERATOR-DRIVEN NEUTRON ACTIVATOR",
}
